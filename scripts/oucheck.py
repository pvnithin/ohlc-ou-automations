...
# Write results to results_all (Option A)
results_folder = "results_all"  # Folder to store results for all stocks
...
# Create results folder if it doesn't exist (under repo root)
